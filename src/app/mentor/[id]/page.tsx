...
export default function MentorBookingPage() {
 ...
 const gradients = [
 'from-blue-500 to-purple-600', 'from-blue-500 to-cyan-500',
 ...
 <h2 className="text-2xl font-bold text-blue-950 mb-2">Mentor Not Found</h2>
 <p className="text-blue-600 mb-6">This mentor profile doesn&apos;t exist or has been removed.</p>
 <Link href="/explore" className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-medium transition-colors">
 Browse Mentors
 </Link>
 </div>
 </div>
 ...
 <div className="bg-white rounded-3xl border border-blue-200 p-10 shadow-xl">
 {/* Success Icon */}
 <div className="w-20 h-20 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-6">
 <CheckCircle className="w-12 h-12 text-emerald-600 " />
 </div>
 <h2 className="text-2xl font-bold text-blue-950 mb-3">Session Booked!</h2>
 <p className="text-blue-600 mb-2">
 Your session with <span className="font-semibold text-blue-950 ">{mentor.profiles?.full_name}</span> has been confirmed.
 </p>

 {/* Session details */}
 <div className="bg-slate-50 rounded-xl p-4 my-6 border border-slate-100 text-left space-y-3">
 ...
 target="_blank"
 rel="noreferrer"
 className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-white border-2 border-blue-200 text-blue-700 rounded-xl font-medium hover:bg-blue-50 :bg-blue-900/30 transition-colors"
 >
 ...
 className="w-full px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-medium transition-colors shadow-lg shadow-blue-500/30 text-center"
 >
 Go to Dashboard
 </Link>
 <Link
 href="/explore"
 className="w-full px-6 py-3 bg-white border border-blue-200 text-blue-800 rounded-xl font-medium hover:border-blue-400 transition-colors text-center"
 >
 Browse More Mentors
 </Link>
 </div>
 ...
 <Link href="/explore" className="flex items-center gap-2 text-sm font-medium text-blue-700 hover:text-blue-600 :text-blue-400 transition-colors">
 ...
 <div className={`h-24 ${getAvatarColor(mentor.profiles?.full_name || '')} relative`}>
 <div className="absolute -bottom-10 left-6">
 <div className={`w-20 h-20 rounded-2xl ${getAvatarColor(mentor.profiles?.full_name || '')} flex items-center justify-center text-white font-bold text-2xl shadow-xl border-4 border-white `}>
 ...
 <h1 className="text-2xl font-bold text-blue-950 mb-1">{mentor.profiles?.full_name}</h1>
 ...
 <div className="mb-6">
 <h3 className="text-sm font-semibold text-blue-800 mb-2 uppercase tracking-wider">About</h3>
 ...
 <span key={tag} className="px-3 py-1.5 text-xs font-medium bg-blue-50 text-blue-600 rounded-lg border border-blue-100 ">
 {tag}
 </span>
 ))}
 </div>
 ...
 <div>
 <h2 className="text-xl font-bold text-blue-950 ">Book a Session</h2>
 <p className="text-sm text-blue-600 ">Select a date and time to schedule your 1-on-1</p>
 </div>
 </div>
 </div>
 ...
 className="p-2 rounded-lg border border-blue-200 hover:bg-slate-50 :bg-slate-800 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
 >
 ...
 : hasSlots
 ? 'bg-white border-blue-200 hover:border-blue-400 :border-blue-500 cursor-pointer'
 : 'bg-white/5 border-slate-100 opacity-60 hover:border-blue-300 :border-slate-600'
 }`}
 >
 <p className={`text-xs font-medium mb-1 ${isSelected ? 'text-blue-200' : 'text-blue-600 '}`}>
 {DAYS_SHORT[date.getDay()]}
 </p>
 <p className={`text-lg font-bold ${isSelected ? 'text-white' : hasSlots ? 'text-blue-950 ' : 'text-slate-400'}`}>
 {date.getDate()}
 </p>
 <p className={`text-[10px] font-medium ${isSelected ? 'text-blue-200' : 'text-slate-400'}`}>
 {date.toLocaleDateString('en-US', { month: 'short' })}
 </p>
 {isToday && (
 <div className={`absolute -top-1 -right-1 w-3 h-3 rounded-full ${isSelected ? 'bg-white' : 'bg-blue-500'} border-2 border-white `} />
 )}
 {hasSlots && !isSelected && (
 ...
 slotCount === 1
 ? 'bg-blue-600 border-blue-600 text-white shadow-lg shadow-blue-500/30'
 : 'bg-white border-blue-200 text-blue-800 hover:border-blue-400 :border-blue-500'
 }`}
 >
 ...
 ? 'bg-blue-600 border-blue-600 text-white shadow-lg shadow-blue-500/30'
 : isDisabled
 ? 'bg-blue-50 border-blue-200 text-slate-400 cursor-not-allowed opacity-50'
 : 'bg-white border-blue-200 text-blue-800 hover:border-blue-400 :border-blue-500 cursor-pointer'
 }`}
 ...
 <div className="col-span-full py-8 text-center bg-slate-50 rounded-xl border border-dashed border-blue-200 ">
 <p className="text-blue-600 text-sm">No available time slots found for this date.</p>
 </div>
 )}
 </div>
 ...
 <div>
 <p className="text-sm text-blue-600 ">Selected Session</p>
 ...
 className="flex items-center gap-2 px-8 py-3.5 bg-blue-600 hover:bg-blue-700 disabled:opacity-70 text-white rounded-xl font-semibold transition-all shadow-xl shadow-blue-500/30 text-base"
 >
 ...
 <h3 className="text-lg font-semibold text-blue-950 mb-2">No Availability Set</h3>
