...
export default function ExplorePage() {
 ...
 <span className="text-lg font-semibold text-foreground tracking-tight">Mentorly</span>
 </Link>
 ...
 className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-foreground hover:bg-primary text-white rounded-lg font-medium text-sm transition-all shadow-sm group/btn"
 >
 View Profile
 ...
 <span className="text-sm font-medium text-foreground">Mentorly</span>
 </div>
 <p className="text-sm text-muted-foreground">
