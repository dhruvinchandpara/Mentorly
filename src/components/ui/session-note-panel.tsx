...
export function SessionNotePanel({
  ...
  return (
    <div className="mt-3 rounded-xl border border-border bg-secondary/60 overflow-hidden">
      {/* Panel header */}
      <div className="flex items-center justify-between px-4 py-2.5 border-b border-border bg-card">
        <div className="flex items-center gap-2">
          ...
          {isLocked && (
            <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-muted text-[var(--fg-faint)] text-[10px] font-semibold">
      ...
      <div className="p-4">
        {readonly ? (
          ...
          <textarea
            ...
            rows={3}
            className="w-full resize-none text-sm text-muted-foreground bg-transparent border-none outline-none placeholder:text-[var(--fg-faint)] leading-relaxed"
          />
        )}
